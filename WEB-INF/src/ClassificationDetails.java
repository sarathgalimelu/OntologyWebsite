...
public class ClassificationDetails extends HttpServlet {
...
//out.println("value"+value);
    try {
      ...
      String queryString = prefix+ "SELECT DISTINCT ?name  {?element table:name ?name. ?element table:atomicNumber ?number. ?element table:classification table:"+value+".} ORDER BY ?number";
