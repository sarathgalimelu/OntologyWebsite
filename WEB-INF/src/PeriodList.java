...
public class PeriodList extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    try {
      ...
      String queryString = prefix+ "SELECT DISTINCT ?name  {?element table:period ?name. ?element table:atomicNumber ?number. ?element table:symbol ?symbol.} ORDER BY ?name";
...
/* 		  name=name.substring(0,name.indexOf("^"));
		 symbol=symbol.substring(0,symbol.indexOf("^")); */
          ...
          out.println("<P><tr><td><a href=\"http://tinman.cs.gsu.edu:8080/vgalimelu1/servlet/PeriodDetails?val="+name+"  \">"+name+"</a></tr></td>");
