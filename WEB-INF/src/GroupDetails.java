...
//out.println("value"+value);
    try {
      ...
      String queryString = prefix+ "SELECT DISTINCT ?name  {?element table:name ?name. ?element table:atomicNumber ?number. ?element table:group table:"+value+".} ORDER BY ?number";
